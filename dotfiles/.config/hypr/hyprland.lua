...
hl.on('hyprland.start', function ()
  ...
  hl.exec_cmd('kitty zsh -c "fastfetch; exec zsh"')
  hl.exec_cmd('firefox', { workspace = "2 silent"})
  hl.exec_cmd('spotify-launcher', { workspace = "4 silent"})
  hl.exec_cmd('prospect-mail', { workspace = "6 silent" })
...
-- Custom Binds
hl.bind(mainMod .. " + Y", hl.dsp.exec_cmd("spotify-launcher"))
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("vesktop"))
hl.bind(mainMod .. " + O", hl.dsp.exec_cmd("okular"))
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd("firefox"))
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd("drawing"))
...
hl.bind(mainMod .. " + SHIFT + PRINT", hl.dsp.exec_cmd("hyprshot -m region -z -o ~/Pictures"))
